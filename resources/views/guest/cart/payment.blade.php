...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="{{ asset('public/guest/vnpay/assets/bootstrap.min.css') }}" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="{{ asset('public/guest/vnpay/assets/jumbotron-narrow.css') }}" rel="stylesheet">  
        <script src="{{ asset('public/guest/vnpay/assets/jquery-1.11.3.min.js') }}"></script>
    </head>
